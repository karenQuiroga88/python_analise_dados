...
caminho = 'C:/Users/sabado/Desktop/python_analise_dados/python_analise_dados-main/'
...
def comparar():
    ...
    if request.method == 'POST':
        ...
        conn = sqlite3.connect(f'{caminho}banco01.bd')
        df = pd.read_sql_query("SELECT country, {eixoX}, {eixoY} FROM bebidas".format(eixoX, eixoY), conn)
        conn.close()
